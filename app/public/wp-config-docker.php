...
define( 'DB_NAME', 'wordpress_db' ); // Giữ nguyên từ file docker-compose

/** MySQL database username */
define( 'DB_USER', 'root' ); // Giữ nguyên từ file docker-compose

/** MySQL database password */
define( 'DB_PASSWORD', 'root' ); // Giữ nguyên từ file docker-compose

/** MySQL hostname */
define( 'DB_HOST', 'db:3306' ); // 'db' là tên service của container mysql
